import {
    ...
    Panel,
    ResourceInstance,
} from 'resources/js/types/resources'
import {
    defineComponent,
    onBeforeUnmount,
    onMounted,
...
const List = defineComponent({
    ...
    props: {
        ...
        resources: {
            type: Array as PropType<ResourceInstance[]>,
            required: true,
        },
        pagination: {
            type: Object as PropType<{
        ...
        fields: {
            type: Array as PropType<FieldOrPanel[]>,
            required: true,
        },
        filtersOptions: {
        ...
        filters: {
            type: Object as PropType<
                Record<string, InstanciatedFilter<unknown>>
            >,
            required: true,
        },
    },
    setup(props) {
        ...
        const newFilters = ref(props.filters)
        onMounted(() => {
        ...
        return {
            ...
            applyFilters: debounce(() => {
                Inertia.visit(
                    route('laravel-admin::resources.list', {
    ...
    render() {
        return (
            <div class="text-gray p-4">
                <Teleport to="title">{this.resource.plural} - Admin</Teleport>
                        ...
                        <div class="ml-auto relative">
                            <div onClick={(e) => e.stopPropagation()}>
                                <button
                                    ...
                                    onClick={() =>
                                        (this.isFilterDropdownOpened = true)
                                    }
                                >
                            ...
                            <tr>
                                {this.resources.length <= 0 ? (
                                    ...
                                    [
                                        ...
                                        <td class="py-2 px-4 w-32 text-right">
                                            Actions
                                        </td>,
                                    ]
                                )}
                            ...
                            {this.resources.map((resourceItem) => (
                                <tr class="border-b border-gray-lighter hover:bg-gray-lightest">
                                    ...
                                    {resourceItem.fields.map((field) =>
                                        field.isPanel ? (
                                            (
                                                field as InstanciatedPanel
                                            ).fields.map((subField) => (
                                                <td class="py-3 px-4">
                                                    {subField.valueForDisplay}
                                                </td>
                                            ))
                                        ) : (
                                            <td class="py-3 px-4">
                                                {
                                                    (
                                                        field as InstanciatedField<unknown>
                                                    ).valueForDisplay
                                                }
                                            </td>
                                        )
                            ...
                            {this.resources.length > 0 ? null : (
                                <tr class="border-b border-gray-lighter">
                                    <td class="p-4 text-center">
                                        No{' '}
                                        {this.resource.singular.toLowerCase()}
                                    </td>
                                </tr>
                            )}
                        </tbody>
                    ...
                    <nav class="text-gray-light">
                        <ul class="p-4 flex justify-between">
                            ...
                            <li>
                                ...
                                on {this.resource.totalCount}
                            </li>
                            <li class="font-bold">
                                {this.pagination.next ? (
                                    <inertia-link href={this.pagination.next}>
                                        Next
                                    </inertia-link>
                                ) : (
                                    <span class="text-gray-lighter cursor-not-allowed">
